...
import type { SideLink } from "@/constants/side-links";
    ...
    <DropdownMenu>
      <Tooltip delayDuration={0}>
        ...
        <TooltipContent side="right" className="flex items-center gap-4">
          {title}{" "}
          {label && (
            <span className="text-muted-foreground ml-auto font-bold text-title">
              {label}
            </span>
          )}
          <IconClose className="text-muted-foreground -rotate-90" />
        </TooltipContent>
      </Tooltip>
